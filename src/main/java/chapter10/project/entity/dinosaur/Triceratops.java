...
public class Triceratops extends TerrestrialDinosaur implements Herbivore {

  public Triceratops(String name, int age, DinosaurSize size, int height, int maxRunningSpeed) {
    super(name, age, DinosaurType.HERBIVORE, DinosaurSpecies.TRICERATOPS, size, height, maxRunningSpeed);
  }
