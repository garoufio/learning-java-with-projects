...
public class Parasaurolophus extends TerrestrialDinosaur implements Herbivore {
  
  public Parasaurolophus(String name, int age, DinosaurSize size, int height, int maxRunningSpeed) {
    super(name, age, DinosaurType.HERBIVORE, DinosaurSpecies.PARASAUROLOPHUS, size, height, maxRunningSpeed);
  }
