...
public class Ankylosaurus extends TerrestrialDinosaur implements Herbivore {
  
  public Ankylosaurus(String name, int age, DinosaurSize size, int height, int maxRunningSpeed) {
    super(name, age, DinosaurType.HERBIVORE, DinosaurSpecies.ANKYLOSAURUS, size, height, maxRunningSpeed);
  }
