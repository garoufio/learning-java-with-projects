...
public class Spinosaurus extends TerrestrialDinosaur implements Omnivore {
  
  public Spinosaurus(String name, int age, DinosaurSize size, int height, int maxRunningSpeed) {
    super(name, age, DinosaurType.OMNIVORE, DinosaurSpecies.SPINOSAURUS, size, height, maxRunningSpeed);
  }
