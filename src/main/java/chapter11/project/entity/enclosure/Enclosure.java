...
import chapter11.project.entity.employee.Employee;
...
public class Enclosure {
  ...
  public Enclosure(EnclosureType enclosureType, SafetyLevel safetyLevel, List<Dinosaur> dinosaurs, List<Employee> employees, int securityLevel) {
  ...
  public void setSecurityLevel(int securityLevel) {
    this.securityLevel = (securityLevel >= 0 && securityLevel <= 100) ? securityLevel : -1;
  }
